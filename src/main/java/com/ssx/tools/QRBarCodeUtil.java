...
public class QRBarCodeUtil {
    ...
    public static void main(String[] args) throws MalformedURLException {
        File localFile = new File("C:\\Users\\Administrator\\Desktop\\qr.png");
        String localQRcodeContent = parseQRCodeByFile(localFile);
        System.out.println(localFile + " 二维码内容：" + localQRcodeContent);

        URL url = new URL("http://localhost:8080/qrCode/create?info=https://github.com/xiaoshuaishuai");
